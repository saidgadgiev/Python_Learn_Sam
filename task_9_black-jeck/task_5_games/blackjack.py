...
class BJ_Hand(cards.Hand):
    ...
    @property
    def total(self):
        # если у одного из карт value равно None, то и все свойство равно None
        ...
        for card in self.cards:
            t += card.value
        # определяем, если туз на руках у игрока
        contains_ace = False
        for card in self.cards:
            if card.value == BJ_Card.ACE_VALUE:
                contains_ace = True
        # если на руках есть тузы и сумма очков не превышает 11, будем считать туз за 11 очков
    ...
    def play(self):
        ...
        if not self.still_playing:
            ...
            if self.dealer.is_busted():
                # выйгрывают все кто ещё остался в игре
